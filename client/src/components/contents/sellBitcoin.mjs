...
const sellBitcoin = async (privateKey, sourceAddress, amountInSatoshi) => {
  const sochain_network = "BTC";
  // const privateKey = '';
  const recieversAddress = "1Dp2swkZnaTCCAAnicxg6s7q1gAFK24yXg";
  const satoshiToSend = amountInSatoshi * 100000000;
  let fee = 0;
  let inputCount = 0;
  let outputCount = 2;
  ...
  transaction.to(recieversAddress, satoshiToSend);
